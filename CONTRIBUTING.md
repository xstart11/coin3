Contributing to Casax Core
============================

The Casax Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Casax Core project, and is not to be
confused with overall Casax Network Protocol consensus changes.

Whether a pull request is merged into Casax Core rests with the project merge
...
Patches that change Casax consensus rules are considerably more involved than
...
Where a patch set proposes to change the Casax consensus, it must have been
...
The project leader is the release manager for each Casax Core release.
