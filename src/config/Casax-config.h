/* src/config/Casax-config.h.  Generated from Casax-config.h.in by configure.  */
/* src/config/Casax-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.casax.cc"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Casax Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Casax Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Casax"
