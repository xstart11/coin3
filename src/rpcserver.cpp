...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Casax features */
        {"Casax", "masternode", &masternode, true, true, false},
        {"Casax", "listmasternodes", &listmasternodes, true, true, false},
        {"Casax", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Casax", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Casax", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Casax", "masternodedebug", &masternodedebug, true, true, false},
        {"Casax", "startmasternode", &startmasternode, true, true, false},
        {"Casax", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Casax", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Casax", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Casax", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Casax", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Casax", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Casax", "mnbudget", &mnbudget, true, true, false},
        {"Casax", "preparebudget", &preparebudget, true, true, false},
        {"Casax", "submitbudget", &submitbudget, true, true, false},
        {"Casax", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Casax", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Casax", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Casax", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Casax", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Casax", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Casax", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Casax", "checkbudgets", &checkbudgets, true, true, false},
        {"Casax", "mnsync", &mnsync, true, true, false},
        {"Casax", "spork", &spork, true, true, false},
        {"Casax", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Casax", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Casaxd, or the -server option to Casax-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Casax-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9115/\n";
}
