...
/** Utility functions used by the Casax Qt UI.
 */
namespace GUIUtil
{
...
// Render Casax addresses in moCasaxpace font
...
// Parse "Casax:" URI into recipient object, return true on successful parsing
