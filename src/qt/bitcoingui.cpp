                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Casax Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Casax address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Casax: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCSX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Casax Core"), this);
    aboutAction->setStatusTip(tr("Show information about Casax Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Casax"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Casax addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Casax addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagCasaxtic information"));
    ...
    openAction->setStatusTip(tr("Open a Casax: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Casax Core help message to get a list with possible Casax command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Casax Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Casax network", "", count));
}
...
{
    QString strTitle = tr("Casax Core"); // default title
...
/** Creates context menu, its actions, and Casaxs up all the relevant signals for mouse events. */
