...
RESOURCES += src/qt/Casax.qrc src/qt/Casax_locale.qrc

TRANSLATIONS += src/qt/locale/Casax_bg.ts \
                src/qt/locale/Casax_de.ts \
                src/qt/locale/Casax_en.ts \
                src/qt/locale/Casax_es.ts \
                src/qt/locale/Casax_fi.ts \
                src/qt/locale/Casax_fr.ts \
                src/qt/locale/Casax_it.ts \
                src/qt/locale/Casax_ja.ts \
                src/qt/locale/Casax_pl.ts \
                src/qt/locale/Casax_pt.ts \
                src/qt/locale/Casax_ru.ts \
                src/qt/locale/Casax_sk.ts \
                src/qt/locale/Casax_sv.ts \
                src/qt/locale/Casax_vi.ts \
                src/qt/locale/Casax_zh_CN.ts \
                src/qt/locale/Casax_zh_TW.ts
