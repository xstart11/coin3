...
In order to support loading of multiple wallets in Casax-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Casax.cpp.
...
Changes to Casax.cpp
----------------------
Casax.cpp is the entry point into Casax-qt, and as such, will require some minor modifications to provide hooks for
